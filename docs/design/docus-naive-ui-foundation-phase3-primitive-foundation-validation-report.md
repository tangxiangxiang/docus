...
- Phase 0: PASS.
- Phase 1: PASS; the production `DocusUiRoot` provider/theme/locale
...
- `11e0c09` — preserve Docus' original Prompt trigger across continuous
...
- `docs/design/docus-naive-ui-foundation-phase3-primitive-foundation-validation-report.md`
