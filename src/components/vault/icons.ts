...
// File outline with a path-drawn "M" inside (no <text>). The M is built
// from five points so the down/up/down/up strokes read clearly even at
// 14px. Used as the file-tree row icon for .md files.
export const ICON_FILE_MD = `
<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  <path d="M3.5 2h5L12 5.5V13a1 1 0 0 1-1 1H3.5a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z"/>
  <path d="M8.5 2v3.5H12"/>
  <path d="M4.5 8.5v3.5l1.5-2 1.5 2V8.5"/>
</svg>`
