...
//
// Three icons that genuinely need the 24x24 surface canvas — their
// geometry is too dense to redraw at 16x16 without losing detail
// (sun rays, gear teeth, crescent shadow).
//
...
// activity button. It uses the same 16×16 inline grid as the folder
// and tag buttons so the Activity Bar stays visually balanced.
