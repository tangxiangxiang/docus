...
<template>
  <section class="right-rail-history" aria-labelledby="right-rail-history-title">
    <header class="right-rail-history-header">
      <strong id="right-rail-history-title">{{ t('rail.history') }}</strong>
...
.right-rail-history-header strong {
