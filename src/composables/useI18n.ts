...
const STRINGS: Strings = {
  ...
  'status.offline': { zh: '离线 · 等待重试', en: 'Offline · waiting to retry' },
  'status.external': { zh: '文件已在磁盘上更改', en: 'File changed on disk' },
  ...
  'history.clear_selection': { zh: '清除选择', en: 'Clear selection' },
  ...
  'history.change_modified': { zh: '已修改', en: 'Modified' },
  'history.change_new': { zh: '新增', en: 'New' },
  'history.change_deleted': { zh: '已删除', en: 'Deleted' },
